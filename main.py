...
# TODO: CARIBU pour un pas de temps, pour une scène fixe, avec les mêmes conditions que cn-wheat
    # problème pour les param optiques : blé a besoin de séparer tige et feuilles
    # réflectance de l-egume : personnaliser sa réflectance? -> pas de réflexion dans l-egume

# TODO: afficher le PAR en plantGL avec une colormap (dans caribu : example/assemby_test/test_light_tutorial.py)
# TODO: distribution de zenith par s2v ou s5 (arriver à exécuter les .exe!! :( )

# TODO: recherche automatique des stems dans le MTG de cn-wheat
# TODO: transfert des résultats de lvm à cn-wheat
