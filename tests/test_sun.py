from lightvegemanager.sun import ratp_sun, caribu_sun, print_sun
import pytest

# global values
day = 250
hour = 10
coordinates = [60.2, 25.0, 3.6]  # Helsinki Finland, UTC+3h
truesolartime = True
...
@pytest.mark.parametrize(
    "test_input, expected", [(truesolartime, expected_globaltime), (localsolartime, expected_localtime)]
)
