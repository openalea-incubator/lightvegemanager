...
def simulation_caribu(SIMULATION_LENGTH, write, outpath):
    ...
    OUTPUTS_DIRPATH = "outputs\\"+outpath
...
def simulation_ratp(SIMULATION_LENGTH, write, outpath):
    # -- SIMULATION PARAMETERS --
    START_TIME = 0
    PLANT_DENSITY = {1: 410}
...
if __name__ == "__main__":
    nstep=2400
    write=True
    outpath = "cn-wheat_outputs_caribu"
    simulation_caribu(nstep,write, outpath)
    simulation_ratp(nstep,write, outpath)
    print("=== END ===")
