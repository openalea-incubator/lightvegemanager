            ...
            if car!=0:
                if shape == 19 or shape == 34:
                    ...
                    if shape==813:
                        ...
                        #feuilles_detail[0].append(ra5-car)
                    
                    elif shape==814:
                        iter_detail[1].append(ite)
                        #feuilles_detail[1].append(ra5-car)

                    elif shape==51:
                        iter_detail[2].append(ite)
                        #feuilles_detail[2].append(ra5-car)

                    elif shape==815:
                        iter_detail[3].append(ite)
                        #feuilles_detail[3].append(ra5-car)

                    elif shape==816:
                        iter_detail[4].append(ite)
                        #feuilles_detail[4].append(ra5-car)
...
plt.title("Différence entre RATP 5mm et CARIBU sur chaque feuille")
plt.legend()
'''
