...
p6 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(8),paste("plante",as.character(5)," "),  "LAI", surfsol)
p7 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(9),paste("plante",as.character(6)," "),  "LAI", surfsol)
p8 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(10),paste("plante",as.character(7)," "),  "LAI", surfsol)
p9 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(11),paste("plante",as.character(8)," "),  "LAI", surfsol)
p10 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(12),paste("plante",as.character(9)," "),  "LAI", surfsol)
p11 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(13),paste("plante",as.character(10)," "),  "LAI", surfsol)
p12 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(14),paste("plante",as.character(11)," "),  "LAI", surfsol)
p13 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(15),paste("plante",as.character(12)," "),  "LAI", surfsol)
p14 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(16),paste("plante",as.character(13)," "),  "LAI", surfsol)
p15 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(17),paste("plante",as.character(14)," "),  "LAI", surfsol)
p16 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(18),paste("plante",as.character(15)," "),  "LAI", surfsol)
p <- plot_grid(
  p1 + theme(legend.position = "none"),
  p2 + theme(legend.position = "none"),
  p3 + theme(legend.position = "none"),
...
p6 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(24),paste("plante",as.character(21)," "), "LAI",  surfsol)
p7 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(25),paste("plante",as.character(22)," "), "LAI",  surfsol)
p8 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(26),paste("plante",as.character(23)," "),  "LAI", surfsol)
p9 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(27),paste("plante",as.character(24)," "), "LAI",  surfsol)
p10 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(28),paste("plante",as.character(25)," "), "LAI",  surfsol)
p11 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(29),paste("plante",as.character(26)," "), "LAI",  surfsol)
p12 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(30),paste("plante",as.character(27)," "), "LAI",  surfsol)
p13 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(31),paste("plante",as.character(28)," "), "LAI",  surfsol)
p14 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(32),paste("plante",as.character(29)," "), "LAI",  surfsol)
p15 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(33),paste("plante",as.character(30)," "), "LAI",  surfsol)
p16 <- subplot_variable_plant(varname, start, end, l1, list("default", "ratp"), list(34),paste("plante",as.character(31)," "),  "LAI", surfsol)
p<-plot_grid(
  p1 + theme(legend.position = "none"),
  p2 + theme(legend.position = "none"),
  p3 + theme(legend.position = "none"),
...
p6 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(8),paste("plante",as.character(5)," "),  "LAI", surfsol)
p7 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(9),paste("plante",as.character(6)," "), "LAI",  surfsol)
p8 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(10),paste("plante",as.character(7)," "),  "LAI", surfsol)
p9 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(11),paste("plante",as.character(8)," "),  "LAI", surfsol)
p10 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(12),paste("plante",as.character(9)," "), "LAI",  surfsol)
p11 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(13),paste("plante",as.character(10)," "), "LAI",  surfsol)
p12 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(14),paste("plante",as.character(11)," "), "LAI",  surfsol)
p13 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(15),paste("plante",as.character(12)," "), "LAI",  surfsol)
p14 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(16),paste("plante",as.character(13)," "),  "LAI", surfsol)
p15 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(17),paste("plante",as.character(14)," "), "LAI",  surfsol)
p16 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(18),paste("plante",as.character(15)," "),  "LAI", surfsol)
p<-plot_grid(
  p1 + theme(legend.position = "none"),
  p2 + theme(legend.position = "none"),
  p3 + theme(legend.position = "none"),
...
p6 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(24),paste("plante",as.character(21)," "),  "LAI", surfsol)
p7 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(25),paste("plante",as.character(22)," "),  "LAI", surfsol)
p8 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(26),paste("plante",as.character(23)," "),  "LAI", surfsol)
p9 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(27),paste("plante",as.character(24)," "),  "LAI", surfsol)
p10 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(28),paste("plante",as.character(25)," "), "LAI",  surfsol)
p11 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(29),paste("plante",as.character(26)," "), "LAI",  surfsol)
p12 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(30),paste("plante",as.character(27)," "),  "LAI", surfsol)
p13 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(31),paste("plante",as.character(28)," "), "LAI",  surfsol)
p14 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(32),paste("plante",as.character(29)," "), "LAI",  surfsol)
p15 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(33),paste("plante",as.character(30)," "), "LAI",  surfsol)
p16 <- subplot_variable_plant(varname, start, end, l2, list("default", "ratp"), list(34),paste("plante",as.character(31)," "), "LAI",  surfsol)
p<-plot_grid(
  p1 + theme(legend.position = "none"),
  p2 + theme(legend.position = "none"),
  p3 + theme(legend.position = "none"),
